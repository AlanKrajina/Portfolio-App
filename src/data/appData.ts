...
export const initialImages: InitialImagesState[] = [
  {
    ...
    summary: [
      ...
      "In the app Player selects a number between 1-99 and the App tries to quess what number it is while Player gives hints if the number is lower or greater but he cannot give a wrong hint, warning modal appears at that point.",
      "When the game ends, Player can see the number of rounds he played and selected number.",
      "For styling app uses Native StyleSheet.create and AppLoading from expo to prolong screen loading until fonts are fetched.",
    ],
  },
  {
    ...
    summary: [
      ...
      "For better productivity app uses libraries like DnD drag and drop action, infinite loader and scroll, svelte slider, easy crop and wvelte navigator.",
    ],
  },
  {
    youTubeSource: "https://www.youtube.com/embed/28mV6BxiXJw",
  ...
  },
  {
    ...
    summary: [
      ...
      "Sign up, login or log out securely as user.",
      "This app includes a third party signup/login via Google thanks to the OmniAuth gem.",
      "User can see all lessons but can only create, update, and delete (CRUD) his own created lesson and browse lessons via name and view users with most lessons created. All inputs are validated.",
